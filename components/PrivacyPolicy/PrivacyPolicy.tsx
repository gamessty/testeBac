...
export default function PrivacyPolicy() {
  return (
    <div>
      <Title order={1}>PRIVACY POLICY</Title> Last updated February 07, 2025{' '}
      <Text>This Privacy Notice for __________ ('we', 'us', or 'our'</Text>{' '}
      <Text>
      ...
      <Text>below to find the section you are looking for.</Text>{' '}
      <Text>
      ...
      <Anchor href="#infouse">
        <Text>how we process your information</Text>
      </Anchor>{' '}
      <Text>.</Text>{' '}
      <Text>
      ...
      <Anchor href="#whoshare">
        <Text>when and with whom we share your personal information</Text>
      </Anchor>{' '}
      <Text>.</Text>{' '}
      <Text>
      ...
      <Anchor href="#infosafe">
        <Text>how we keep your information safe</Text>
      </Anchor>{' '}
      <Text>.</Text>{' '}
      <Text>
      ...
      <Anchor
        ...
        target="_blank"
      >
        <Text>data subject access request</Text>
      </Anchor>{' '}
      <Text>
      ...
      <Anchor href="#toc">
        <Text>Review the Privacy Notice in full</Text>
      </Anchor>{' '}
      <Text>.</Text> <Title order={2}>TABLE OF CONTENTS</Title>{' '}
      ...
      <Text>In Short:</Text>{' '}
      <Text>We collect personal information that you provide to us.</Text>{' '}
      <Text>
      ...
      <Text>
        ...
        social media provider, as described in the section called 'HOW DO WE
      ...
      <Anchor
        ...
        target="_blank"
      >
        <Text>Google API Services User Data Policy</Text>
      </Anchor>{' '}
      ...
      <Anchor
        ...
        target="_blank"
      >
        <Text>Limited Use requirements</Text>
      </Anchor>{' '}
      <Text>.</Text>{' '}
      ...
      <Text>
        ...
        organisation apart from us. They also commit to pr
      </Text>{' '}
      <Text>
        otect the data they hold on our behalf and to retain it for the period
        we instruct.
      </Text>{' '}
      <Text>
      ...
      <Text>
        ...
        refuse certain cookies is set out in our Cookie Notice: __________.
      </Text>{' '}
      <Title order={2}>6. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</Title>{' '}
      <Text>
      ...
      <Title order={2}>9. WHAT ARE YOUR PRIVACY RIGHTS?</Title>{' '}
      <Text>
      ...
      <Anchor
        ...
        target="_blank"
      >
        <Text>UK data protection authority</Text>
      </Anchor>{' '}
      <Text>.</Text>{' '}
      <Text>
      ...
      <Text>' below or updating your preferences.</Text>{' '}
      <Text>
      ...
      <Title order={2}>10. CONTROLS FOR DO-NOT-TRACK FEATURES</Title>{' '}
      <Text>
      ...
      <Title order={2}>11. DO WE MAKE UPDATES TO THIS NOTICE?</Title>{' '}
      <Text>
      ...
      <Title order={2}>12. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</Title>{' '}
      <Text>
